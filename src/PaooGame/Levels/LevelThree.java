...
//                {new Door(4, 3, 0, 4* Tile.TILE_HEIGHT, 6*Tile.TILE_WIDTH-10, 1*Tile.TILE_HEIGHT, 10, Tile.TILE_HEIGHT),
        ...
        this.entity = new Entity[][] {
                ...
                {cameraFactory.createEntity(9 * Tile.TILE_WIDTH + (3 * Tile.TILE_WIDTH) / 4 - 1, 0),
                        cameraFactory.createEntity(0, 0)}, // 2
                {cameraFactory.createEntity(9 * Tile.TILE_WIDTH + (3 * Tile.TILE_WIDTH) / 4 - 1, 0),
        ...
        ((Camera) entity[2][0]).setAnim(true, 45, 100);
        ((Camera) entity[2][1]).setAnim(false, -45, 100);
        ...
        ((Camera) entity[5][0]).setAnim(true, 45, 100);
        ((Camera) entity[5][1]).setAnim(false, -45, 100);
        ((Camera) entity[6][0]).setAnim(true, 45, 100);
        ((Camera) entity[6][1]).setAnim(false, -45, 100);
